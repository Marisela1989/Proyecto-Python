...
# Form implementation generated from reading ui file 'c:\Users\HP\OneDrive - Universidad Internacional de las Américas (UIA)\Escritorio\Proyecto-Python\ProyectoFinal\ProyectoFinal\ProyectoFinal\ProyectoFinal\empleado.ui'
#
...
class Ui_Empleado(object):
    def setupUi(self, Empleado):
        ...
        Empleado.resize(1000, 800)
        Empleado.setMinimumSize(QtCore.QSize(1000, 800))
        icon = QtGui.QIcon()
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(330, 160, 391, 231))
        ...
        self.lblTitulo.setGeometry(QtCore.QRect(470, 60, 121, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.lblTitulo.setFont(font)
        self.lblTitulo.setObjectName("lblTitulo")
        self.horizontalLayoutWidget = QtWidgets.QWidget(Empleado)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(280, 420, 471, 80))
        ...
        self.lblImagen.setGeometry(QtCore.QRect(830, 100, 141, 131))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 520, 961, 192))
