...
# Form implementation generated from reading ui file 'c:\Users\HP\OneDrive - Universidad Internacional de las Américas (UIA)\Escritorio\ProyectoFinal\Usuario.ui'
#
...
class Ui_Usuario(object):
    def setupUi(self, Usuario):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(200, 160, 391, 231))
        ...
        self.lblImagen.setPixmap(QtGui.QPixmap("c:\\Users\\HP\\OneDrive - Universidad Internacional de las Américas (UIA)\\Escritorio\\ProyectoFinal\\recursos/avatar.jpeg"))
    ...
    def retranslateUi(self, Usuario):
        ...
        self.lblCedula.setText(_translate("Usuario", "Cedula:"))
        self.lblNombre.setText(_translate("Usuario", "Nombre:"))
        self.lblApellidos.setText(_translate("Usuario", "Apellidos:"))
        self.lblTelefono.setText(_translate("Usuario", "Telefono:"))
        self.lblDireccion.setText(_translate("Usuario", "Direccion:"))
        self.lblPuesto.setText(_translate("Usuario", "Puesto:"))
        self.lblFechaIngreso.setText(_translate("Usuario", "Fecha de Ingreso:"))
